...
public final class UseWarehouse {
    ...
    public static void main(final String[] args) {
    	...
    	final Product p1 = new ProductImpl("p1", 3.8);
        final Product p2 = new ProductImpl("p2", 100);
        final Product p3 = new ProductImpl("p3", 33);
        ...
        System.out.println(w.containsProduct(p3));
        System.out.println(w.getQuantity("p1"));
